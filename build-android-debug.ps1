...
# Builds a debug APK for HearthsideYarn Android app.

$ErrorActionPreference = "Stop"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host " HearthsideYarn - Building Debug APK   " -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "[3/4] Gradle assembleDebug..." -ForegroundColor Yellow
